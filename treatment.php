...
<body>
        <!--[if lt IE 8]>
            ...
            <div class="ui main text container ">
            	<img class="ui centered  image" src="img/treatment.png">
            	
            	<h3 class="header-title">ANTIRETROVIRAL TREATMENT FOR HIV</h3>
            	<p>If you’re living with HIV then taking treatment is really important for your health as it reduces the amount of HIV in your body and helps boost your immune system.</p>
